...
# %% Forward path
    ...
    def forward(self, z_dict, edge_index_dict, edge_label_index):
        ...
        for i in range(0, self.num_layers_after_merging):
            ...
            # self.intermediate_representations.append(graph_x_update)  ### graph_x_update
...
class EdgeDecoder(torch.nn.Module):
    ...
    def forward(self, z, edge_label_index):
        ...
        # ( z[edge_label_index[0]] * z[edge_label_index[1]].t() )
...
def train():
    ...
    # edge_label = train_data['Prot', 'Drug'].edge_label
    # %% Model output
...
# Assuming hyper_hidden_channel, hyper_layer, and best_val_auc_record are defined as per your context
