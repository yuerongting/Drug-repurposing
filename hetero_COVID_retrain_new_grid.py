...
with open("Data/data_index_covid.pickle", 'rb') as f:
# with open("H:\\Users\\yrt05\\Desktop\\Zika virus drug\\data_06_20_index.pickle", 'rb') as f:
...
indices_in_A_bar = torch.load("Data/covid_indices_in_A_bar_50_nodes.pth")
...
for node_type in data.node_types:
    ...
    #%% remove edge
        ...
        # data[node_type].num_nodes = data[node_type].num_nodes - len(indices_in_A_bar)

data['Prot'].x[indices_in_A_bar] = 0
...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, hidden_channels, out_features, num_layer):
        ...
        random_seed = 98765  ### 6 16 0.86 grid
