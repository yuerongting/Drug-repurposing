...
tar_file_path <- "\Zika virus drug\\GSE235210_RAW.tar"
# Specify the directory where you want to extract the files
extract_dir <- "\Zika virus drug\\extracted_files\\"
...
DEG_info <- filter(DEG_voom, rownames(DEG_voom) %in% DEG_total)

write.csv(DEG_info, "DEG_info.csv", row.names=TRUE)
